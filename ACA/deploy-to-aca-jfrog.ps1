# Azure Container Apps Deployment Script - JFrog Registry Edition
...
#   - JFrog Artifactory account with Docker repository access
#   - .NET 9.0 base images available in JFrog (mirrored/proxied from MCR)
#
# JFROG SETUP:
